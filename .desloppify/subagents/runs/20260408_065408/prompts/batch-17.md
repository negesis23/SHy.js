...
Repository root: /workspaces/codespaces-blank
Blind packet: /workspaces/codespaces-blank/.desloppify/review_packet_blind.json
Batch index: 17
...
Overview (12 signals):
  design_concern: 12 — packages/shy/src/components/Dynamic.ts, packages/shy/src/components/ErrorBoundary.ts, ...
...
For each concern, read the source code and report your verdict in issues[]:
  ...
  - [design_concern] packages/shy/src/components/Dynamic.ts
    ...
    evidence: [orphaned] Orphaned file (16 LOC): zero importers, not an entry point
    fingerprint: 71d11e56a97deea7
  - [design_concern] packages/shy/src/components/ErrorBoundary.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (23 LOC): zero importers, not an entry point
    fingerprint: 608fabd10b430fb9
  - [design_concern] packages/shy/src/components/For.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (90 LOC): zero importers, not an entry point
    fingerprint: ca3c76d3a01684a9
  - [design_concern] packages/shy/src/components/Index.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (90 LOC): zero importers, not an entry point
    fingerprint: f1c6c4911be4e512
  - [design_concern] packages/shy/src/components/Portal.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (27 LOC): zero importers, not an entry point
    fingerprint: acf14fbdcc3ea705
  - [design_concern] packages/shy/src/components/Suspense.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (30 LOC): zero importers, not an entry point
    fingerprint: 7df377b7f09461c2
  - [design_concern] packages/shy/src/reactivity/core.ts
    ...
    fingerprint: 290be3d083984ad8
  - [design_concern] packages/shy/src/reactivity/memo.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (44 LOC): zero importers, not an entry point
    fingerprint: 74f965c1c0ae7f48
  - [design_concern] packages/shy/src/reactivity/resource.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (84 LOC): zero importers, not an entry point
    fingerprint: d5ad903d765a6461
  - [design_concern] packages/shy/src/reactivity/signal.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (32 LOC): zero importers, not an entry point
    fingerprint: 4e3fb7f3d1c37c25
  - [design_concern] packages/shy/src/runtime/jsx.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (86 LOC): zero importers, not an entry point
    fingerprint: c14f092a5191852f
  - [design_concern] packages/shy/src/runtime/reconciler.ts
    summary: Design signals from orphaned, smells
    question: Is this file truly dead, or is it used via a non-import mechanism (dynamic import, CLI entry point, plugin)?
    evidence: Flagged by: orphaned, smells
    evidence: [orphaned] Orphaned file (93 LOC): zero importers, not an entry point
    fingerprint: 484b5f347b415f26
